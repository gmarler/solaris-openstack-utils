...
#cat $name | glance image-create --container-format bare --disk-format raw --name $iname --property architecture=$imgarch --property hypervisor_type=solariszones --property vm_mode=solariszones
